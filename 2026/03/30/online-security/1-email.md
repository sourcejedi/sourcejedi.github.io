...
[email-recovery-sheet]: https://docs.google.com/document/d/1ZAxZx4HhLGFB1g8--WEUbBLS4cqpaznN3je9jcyHWpw/
...
Two-step verification is a key feature of the accounts below.  If your email account is not listed here, please skip down to [option 2](#strong-and-separate-password) instead.
...
Even if 2-Step Verification is turned off, Google requires a "second step" whenever they decide a sign-in attempt is "suspicious".  The best approach is to work out a recovery plan, and then make sure 2-Step Verification is turned on.
 ...
 - Google Help: [Turn on 2-Step Verification](https://support.google.com/accounts/answer/185839?hl=en&ref_topic=7189195&co=GENIE.Platform%3DDesktop)

 - Google Help: [Avoid getting locked out of your Google Account](https://support.google.com/accounts/answer/7684753?hl=en)
